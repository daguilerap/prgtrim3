        ...
        try {
            ...
            while (consul.next()) {
                empresa = new emp(consul.getString("COD_EMPRESA"), consul.getString("NOM_EMPRESA"), consul.getString("CIF"),
                        consul.getString("LOCALI"), consul.getString("DIREC"), consul.getString("CP"), consul.getString("TIP_JORNADA"), consul.getString("DNI_RESP"), consul.getString("NOM_RESP"), consul.getString("APELLIDO_RESP"), consul.getString("DNI_TUTOR"),
...
///////////ficheros a tabla//////////////////////////////////////////////////////////////
    ...
    public String ExtraerBinario() throws SQLException {
        ...
        try {
            ...
            fileInpStr = new FileInputStream("src/gest/alumnos2CFS.dat");
    ...
    public String ExtraerXML() throws SQLException {
        ...
        File moviesFile = new File("src/gest/tutoresSAFA.xml");
        String mensaje="";
        try {
            Class.forName(ADD_DRIVER);
            conexBd = DriverManager.getConnection(URL_CONEXION, usuario, contrasenia);
    ...
    public ArrayList<String> rellenaCombalum() throws SQLException {
    ...
    public ArrayList<String> rellenaCombempre() throws SQLException {
        ArrayList<String> comb = new ArrayList<>();
        try {
            Class.forName(ADD_DRIVER);
            conexBd = DriverManager.getConnection(URL_CONEXION, usuario, contrasenia);
    ...
    public ArrayList<String> rellenaCombtut() throws SQLException {
        ArrayList<String> comb = new ArrayList<>();
        try {
            Class.forName(ADD_DRIVER);
            conexBd = DriverManager.getConnection(URL_CONEXION, usuario, contrasenia);
    ...
    public String texto( String Nombrealum, String Nombreempre, String Nombretutor) {
